           ...
           <div class="panel-body"><!-- panel-body Begin -->
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Product Offer </label>

                      <div class="col-md-6"><!-- col-md-6 Begin -->

                      <select name = "product_label" class="form-control">
                          <!-- <input name="product_label" type="text" class="form-control"> -->
                          <option <?php echo $val1 ?> >sale</option>
                          <option <?php echo $val2 ?> >new</option>
                     </select> 
...
if(isset($_POST['update'])){
    ...
    ,product_keywords='$product_keywords',product_desc='$product_desc',product_sale='$product_sale',
    product_label='$product_label',product_price='$product_price' where product_id='$p_id'";
    ...
    if($run_product){
       ...
       echo "<script>window.open('index.php?view_products','_self')</script>";
        ...
        $update_product = "update products set p_cat_id='$product_cat',cat_id='$cat',date=NOW(),product_title='$product_title'
        ,product_price='$product_price',product_keywords='$product_keywords',product_desc='$product_desc'
        ,product_label='$product_label',product_sale='$product_sale' where product_id='$p_id'";
