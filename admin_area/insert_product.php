...
$insert_product="insert into products ( `p_cat_id`, `cat_id`, `date`, `product_title`, `product_img1`, `product_img2`, `product_img3`, `product_price`, `product_desc`, `product_keywords`,`product_label`,`product_sale`)
values('$product_cat','$cat',Now(),'$product_title','$product_img1','$product_img2','$product_img3','$product_price','$product_desc','$product_keywords','$product_label','$product_sale')";
...
if($run_product){
  ...
  echo "Product not inserted retry please !";
}
}
?>
